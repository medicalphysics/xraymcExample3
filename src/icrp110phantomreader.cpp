...
ICRP110PhantomReader ICRP110PhantomReader::readFemalePhantom()
{
    return readPhantom<true>("AF.dat", "AF_media.dat", "AF_organs.dat");
}

ICRP110PhantomReader ICRP110PhantomReader::readMalePhantom()
{
    return readPhantom<false>("AM.dat", "AM_media.dat", "AM_organs.dat");
}